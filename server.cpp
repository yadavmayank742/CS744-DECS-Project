...
const char banner[] = "\n" STYLE /* This banner is displayed when a client connects */
                      ...
                      "█_█_█_█_█_█_█_█_█_█_█_█_█ <  Remote Shell (RSH)      >█_█_█_█_█_█_█_█_█_█_█_█_█_█ " STYLE
                      "\n" STYLE
                      "    Welcome to CLI server ...                                                     " STYLE
                      "    Developed by Mayank Yadav                                                     " STYLE
                      "\n" STYLE
                      ...
                      "  4) To execute a shell command on a user who permits one's shell access, use    " STYLE
                      ...
                      "  5) The --pull-- command deliberately uploads a file from the client side onto   " STYLE
                      "     the server. It will command the client program to upload the prescribed file." STYLE
                      "     '--pull-- @[username] --file-- [accurate filename]' is its syntax.           " STYLE
                      "  6) Similarly, the --push-- command performs the opposite action, commanding     " STYLE
                      "     the client to download the prescribed file from the server.                  " STYLE
                      "  7) To view all online users, type command '--anyonehere--'. You will get a list " STYLE
                      "     of all available users with their IP addresses.                              " STYLE
                      "     '--push-- @[username |--all--] --file-- [accurate filename]' is its syntax.  " STYLE
                      "  8) To exit the room, just send '--exit--' to the server to terminate your       " STYLE
                      "     connection.                                                                  " STYLE
                      "                                                                                  \033[0m\n\n"
